...
Public Class Form1
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        Select Case Me.ComboBox1.Text
            Case "01: Minuet - Luigi Boccherini" : PlaySelectedSong(My.Resources._01)
            Case "02: Nocturne op.9 No.2 - Chopin" : PlaySelectedSong(My.Resources._02)
            Case "03: Peer Gynt (Morning) - Grieg" : PlaySelectedSong(My.Resources._03)
            Case "04: Peer Gynt Suite No.1 (In the Hall of the Mountain King) - Grieg" : PlaySelectedSong(My.Resources._04)
            Case "05: Piano Concerto No.1 - Tchaikovsky" : PlaySelectedSong(My.Resources._05)
            Case "06: Piano Sonata No. 14 (Moonlight Sonata) - Beethoven" : PlaySelectedSong(My.Resources._06)
            Case "07: Piano Sonata No.8 (Patheyique 3rd movement) - Beethoven" : PlaySelectedSong(My.Resources._07)
            Case "08: Radetzky March - Johann Strauss Sr." : PlaySelectedSong(My.Resources._08)
            Case "09: Requiem Dies Irae - Mozart" : PlaySelectedSong(My.Resources._09)
            Case "10: Salut d’Amour Op.12 - Edward Elgar" : PlaySelectedSong(My.Resources._10)
            Case "11: Swan Lake - Tchaikovsky" : PlaySelectedSong(My.Resources._11)
            Case "12: Symphony No. 9  (New World 2nd Movement) - Dvorak" : PlaySelectedSong(My.Resources._12)
        End Select
    End Sub
